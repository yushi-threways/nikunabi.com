class Shops::AddressesController < Shops::ApplicationController
  ...
  private
    ...
    def address_params
      params.require(:address).permit(:shop_id, :city_id, :area_id, :zipcode, :street, :station, :prefecture, :full_address, :latitude, :longitude)
    end
end
