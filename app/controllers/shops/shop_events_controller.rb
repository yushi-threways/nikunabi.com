class Shops::ShopEventsController < Shops::ApplicationController
  ...
  def create
    @shop_event = current_shop.shop_events.build(shop_event_params)
  ...
  private
    ...
    def shop_event_params
      params.require(:shop_event).permit(:title, :content, :image, :closed_at, :published_at, :image_cache, :remove_image)
    end
end
